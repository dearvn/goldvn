...
import 'package:giavang/helpers/database_helper.dart';
import 'package:giavang/models/storage/storage.dart';

class DollarStorageClient {

  final StoreRef<int, Map<String, dynamic>>  _store = intMapStoreFactory.store('dollar_storage_client');
